...
if __name__ == "__main__":
    ...
    parser.add_argument("--cue_model_path", "-cmp", type=str, required=True) # the path inside models_dir
    parser.add_argument("--scope_model_path", "-smp", type=str, required=True) # the path inside models_dir 
    ...
    #c_full_path = os.path.join(os.environ["USERWORK"], f"models/{args.cue_model_path}")
    #s_full_path = os.path.join(os.environ["USERWORK"], f"models/{args.scope_model_path}")
